...
export const RecipeItemCard=({recipe, clickFn})=>{
    ...
    return(
        <Card  justify={'center'} cursor={'pointer'} ml= {2} variant= 'outline' w= {300} onClick={()=>clickFn(recipe)}>
            <Image 
                src={recipe.image} 
                w={100} 
                h={100} 
                ...
                padding={2}
            />
            <Heading size={'md'} color= {{base: 'red', sm: 'green'}} margin={3}> {recipe.label}</Heading>
